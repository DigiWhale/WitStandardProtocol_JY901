...
def readCompassConfig(device):
    ...
    print("AXOFFSET:", device.readReg(0x05, 1))
    print("AYOFFSET:", device.readReg(0x06, 1))
    print("AZOFFSET:", device.readReg(0x07, 1))
    print("GXOFFSET:", device.readReg(0x08, 1))
    print("GYOFFSET:", device.readReg(0x09, 1))
    print("GZOFFSET:", device.readReg(0x0A, 1))
    print("HXOFFSET:", device.readReg(0x0B, 1))
    print("HYOFFSET:", device.readReg(0x0C, 1))
    print("HZOFFSET:", device.readReg(0x0D, 1))
    print("D0MODE:", device.readReg(0x0E, 1))
    print("D1MODE:", device.readReg(0x0F, 1))
    print("D2MODE:", device.readReg(0x10, 1))
    print("D3MODE:", device.readReg(0x11, 1))
    print("IICADDR:", device.readReg(0x1A, 1))
    print("LEDOFF:", device.readReg(0x1B, 1))
    # Add more print statements for each register
    print("WERROR:", device.readReg(0x6A, 1))
    print("TIMEZONE:", device.readReg(0x6B, 1))
    print("WZTIME:", device.readReg(0x6E, 1))
    print("WZSTATIC:", device.readReg(0x6F, 1))
    # Add more print statements for each register
