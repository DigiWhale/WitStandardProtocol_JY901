...
def readCompassConfig(device):
    ...
    print("Output frequency:", device.readReg(0x03, 1), "(Output frequency, 16-bit unsigned integer)")
    print("Output mode:", device.readReg(0x02, 1), "(Output mode, 8-bit unsigned integer)")
    print("Orientation:", device.readReg(0x23, 1), "(Orientation, 8-bit unsigned integer)")
    print("Mode:", device.readReg(0x24, 1), "(Mode, 8-bit unsigned integer)")
    print("K-value:", device.readReg(0x25, 1), "(K-value, 16-bit unsigned integer)")
    print("Acceleration filter:", device.readReg(0x2A, 1), "(Acceleration filter, 16-bit unsigned integer)")
    print("Send data on power on:", device.readReg(0x2D, 1), "(Send data on power on, 8-bit unsigned integer)")
    # Add more print statements for each register
    print("AXOFFSET:", device.readReg(0x05, 1), "(Acceleration X-axis zero offset, 16-bit unsigned integer)")
    print("AYOFFSET:", device.readReg(0x06, 1), "(Acceleration Y-axis zero offset, 16-bit unsigned integer)")
    print("AZOFFSET:", device.readReg(0x07, 1), "(Acceleration Z-axis zero offset, 16-bit unsigned integer)")
    print("GXOFFSET:", device.readReg(0x08, 1), "(Angular velocity X bias, 16-bit unsigned integer)")
    print("GYOFFSET:", device.readReg(0x09, 1), "(Angular velocity Y bias, 16-bit unsigned integer)")
    print("GZOFFSET:", device.readReg(0x0A, 1), "(Angular velocity Z bias, 16-bit unsigned integer)")
    print("HXOFFSET:", device.readReg(0x0B, 1), "(Magnetic field X bias, 16-bit unsigned integer)")
    print("HYOFFSET:", device.readReg(0x0C, 1), "(Magnetic field Y bias, 16-bit unsigned integer)")
    print("HZOFFSET:", device.readReg(0x0D, 1), "(Magnetic field Z bias, 16-bit unsigned integer)")
    print("D0MODE:", device.readReg(0x0E, 1), "(D0 Pin Mode, 16-bit unsigned integer)")
    print("D1MODE:", device.readReg(0x0F, 1), "(D1 Pin Mode, 16-bit unsigned integer)")
    print("D2MODE:", device.readReg(0x10, 1), "(D2 Pin Mode, 16-bit unsigned integer)")
    print("D3MODE:", device.readReg(0x11, 1), "(D3 Pin Mode, 16-bit unsigned integer)")
    print("IICADDR:", device.readReg(0x1A, 1), "(Device address, 8-bit unsigned integer)")
    print("LEDOFF:", device.readReg(0x1B, 1), "(Turn off LED light, 8-bit unsigned integer)")
    # Add more print statements for each register
    print("WERROR:", device.readReg(0x6A, 1), "(Gyroscope change value, 16-bit unsigned integer)")
    print("TIMEZONE:", device.readReg(0x6B, 1), "(GPSTimezone, 8-bit unsigned integer)")
    print("WZTIME:", device.readReg(0x6E, 1), "(Angular velocity continuous rest time, 16-bit unsigned integer)")
    print("WZSTATIC:", device.readReg(0x6F, 1), "(Angular velocity integral threshold, 16-bit unsigned integer)")
    # Add more print statements for each register
