...
def readCompassConfig(device):
    ...
    print("AXOFFSET:", device.readReg(0x05, 1)/10000, "(Acceleration X-axis zero offset)")
    print("AYOFFSET:", device.readReg(0x06, 1)/10000, "(Acceleration Y-axis zero offset)")
    print("AZOFFSET:", device.readReg(0x07, 1)/10000, "(Acceleration Z-axis zero offset)")
    print("GXOFFSET:", device.readReg(0x08, 1)/10000, "(Angular velocity X bias)")
    print("GYOFFSET:", device.readReg(0x09, 1)/10000, "(Angular velocity Y bias)")
    print("GZOFFSET:", device.readReg(0x0A, 1)/10000, "(Angular velocity Z bias)")
